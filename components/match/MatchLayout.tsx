 ...
 *   cabecera → contador → cancha → card de acción → listas → compartir.
  ...
  return (
    <main
      className={[
        ...
        "lg:grid lg:max-w-[1280px] lg:grid-cols-[344px_minmax(0,1fr)] lg:grid-rows-[auto_auto_auto_auto_1fr]",
        "lg:gap-x-8 lg:gap-y-[22px] lg:p-8",
        "lg:[grid-template-areas:'header_pitch''stat_pitch''card_pitch''rosters_pitch''share_pitch']",
      ].join(" ")}
    >
      ...
      <div className="lg:[grid-area:rosters]">{rosters}</div>
